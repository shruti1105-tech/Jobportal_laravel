                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="font-size: 15px;height: 35px"
                                           id="job_name" name="job_name" placeholder="Job Name" value="{{ $job->job_name }}">
                                </div>
{{--                                <div class="form-group">--}}
...
{{--                                </div>--}}
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="font-size: 15px;height: 35px"
                                           id="description" name="description" placeholder="Job Description" value="{{ $job->description }}">
                                </div>
                                <div class="form-group">
                                    <label for="position">Job Position</label>
                                    <input type="text" class="form-control" style="font-size: 15px;height: 35px"
                                           id="position" name="position" placeholder="Job Position" value="{{ $job->position }}">
                                </div>
                                <div class="form-group">
                                    <label for="type">Job Type</label>
                                    <input type="text" class="form-control" style="font-size: 15px;height: 35px"
                                           id="type" name="type" placeholder="Job Type" value="{{ $job->type }}">
                                </div>
